...
callback:function(){}},k);f=jQuery("");c.data("qd_simpleCartOpts",e);j=function(a,b){var d=parseInt(a,10);isNaN(d)?g("O valor obtido para calcular o plural/singular n\u00e3o \u00e9 um n\u00famero!"):1===d?b.hide().filter(".singular").show():b.hide().filter(".plural").show()};h=function(a,b){var d;d=a.find(".amount-items-em").html();1>a.filter(".cartInfoWrapper").length||(b.$this.show(),b.cartTotalE.html(a.find(".total-cart-em").html()),b.cartQttE.html(d),j(d,b.itemsTextE))};a.ajax({url:"/no-cache/QuantidadeItensCarrinho.aspx",
success:function(j){c.each(function(){var b={},d;d=a(this);b.$this=d;b.cartQttE=d.find(e.cartQtt)||f;b.cartTotalE=d.find(e.cartTotal)||f;b.itemsTextE=d.find(e.itemsText)||f;h(a(j),b)})},error:function(){g("N\u00e3o foi poss\u00edvel fazer a requisi\u00e7\u00e3o p/ obter os dados do carrinho.");-1<document.location.host.indexOf("localhost")&&c.show()}});e.callback();return c};a.fn.simpleCart.elements=a("");var h;h=ajaxRequestbuyButtonAsynchronous;ajaxRequestbuyButtonAsynchronous=function(k,c,g,f,e){h.call(this,
k,c,g,f,function(){"function"===typeof e&&e();a.fn.simpleCart.elements.each(function(){var c;c=a(this);c.simpleCart(c.data("qd_simpleCartOpts"))})})};a(function(){a(".qd-CartAuto").simpleCart()})})(jQuery);
/**
