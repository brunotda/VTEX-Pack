	...
	var exec=function()
	{
		_this.each(function(){
			...
			var fns=
			{
				...
				{
					if(_console) console.log("[Cart2 - Erro] ao fazer a requisição p/ obter os dados do carrinho.");
				...
				singularPlural:function(quantity)
				{
					...
					if(!isNaN(qtt))
						...
						if(_console) console.log("[Cart2 - [Error] o valor obtido para calcular o plural/singular não é um número!");
				}
			}
