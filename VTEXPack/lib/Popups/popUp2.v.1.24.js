...
jQuery.fn.vtexPopUp2=function(opts)
{
	...
	var defaults=
		{
			...
			quickViewClass:".quickViewLink", // Classe do quickview caso use uma diferente do padrão "quickViewLink"
			contentUrl:"", // Url para ser exibida em um iframe no popup (válido apenas p/ o "freeContent")
	...
	var fns=
    {
		...
		{
			var elem=elem.filter(":not(.popUpPublishReviewActivated)"),
				requestOn=false;
