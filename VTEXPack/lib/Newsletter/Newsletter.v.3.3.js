...
jQuery.fn.vtexNews2=function(opts)
{
	...
	if("function"!==typeof jQuery.fn.vtexPopUp2){if(_console) console.log("[vtexNews2 - Erro] O popUp2 não foi encontrado. Adicione o Plugin de PopUp2."); return _this;}
	...
	_this.each(function(){
		...
		if(elemSuccess.length<1 || elemError.length<1){if(_console) console.log("[vtexNews2] A(s) mensagem(ns) de erro e/ou sucesso esta(m) faltando \n ("+elemSuccess.selector+", "+elemError.selector+")"); return elem;}
